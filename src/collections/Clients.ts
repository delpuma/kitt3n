...
export const Clients: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'upload',
          relationTo: 'media', // ✅ Ensuring proper relation to media collection
        },
        {
          name: 'scheduledDate',
      ...
      admin: {
        description: 'Social media posts generated by AI and awaiting approval.',
      },
    },

    {
      ...
      type: 'relationship', // ✅ Connects Clients to BlogPosts Collection
      relationTo: 'blogPosts',
      hasMany: true, // Allow multiple blog posts per client
    },
  ],
};
